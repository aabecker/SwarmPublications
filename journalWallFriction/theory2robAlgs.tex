...
\subsection{$\Delta$ Configuration Space}
 ...
 Given an $n$-sided convex polygon $P$, the $\Delta$ configuration space is an $2n$-sided convex polygon.
...
(right) The reachable sets in the $\Delta$ configuration space is shown.
}
\end{figure}
