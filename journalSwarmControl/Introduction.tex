...
Our early work with over a hundred hardware robots and thousands of simulated particles demonstrated that direct human control of large swarms is possible, \cite{Becker2013b}. 
...
\caption{\label{fig:bigPictureMeanAndVarianceForSwarm} A swarm of particles, all controlled by a uniform force field, can be effectively controlled by a hybrid controller that knows only the mean and variance of the robot distribution.  Here a swarm of particles pushes a green hexagon toward the goal 
