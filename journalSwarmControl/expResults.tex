...
\caption{
\label{fig:ResVaryNu}Data from \emph{Varying Number} using robots to push an object through a maze to a goal location.  Best-fit linear and quadratic lines are overlaid for comparison. 
