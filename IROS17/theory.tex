...
%Instead of pushing our robots directly into a wall, 
...
If  $\Delta e\ineq (0,0)$ then we consider the reachable set as shown in Fig.~\ref{fig:regionMove}. If a robot is touching a wall, the other robot can go where ever in the reachable set while the first robot is not moving. Two reachable sets are possible, horizontal and vertical. 
