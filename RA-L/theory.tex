...
The region of integration $R$ is the polygon containing the swarm. If $A<1/2$ and the force angle is $\beta$, the mean when the swarm is in the lower-left corner is:
