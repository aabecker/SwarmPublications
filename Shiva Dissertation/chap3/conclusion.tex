...
%Future efforts should be directed toward examining the effects of Brownian noise, extending this analysis to 3D, pose control for multiple-part assembly, trajectory prediction, and manipulation in crowded workspaces.
