...
Most literature on robotic manipulation assumes intelligent agents and not particle systems manipulated by a global signal.
%Many aspects of these systems can be studied, from control models to human factors.
...
a collection of online games where players steer swarms of up to 500 particles to complete manipulation challenges. We record statistics from over ten thousand players.%, and use the game to explore aspects of large-population particle control. We present the game framework as an open-source tool for large-scale user experiments. 
