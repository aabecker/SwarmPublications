...
%\\
\begin{overpic}[width =\figwid]{VaryControl.pdf}	\put(10,80){\textbf{a} }\end{overpic}~
\begin{overpic}[width =\figwid]{VaryForage.pdf}	\put(10,80){\textbf{b} }\end{overpic}~
\begin{overpic}[width =\figwid]{Predator.pdf}	\put(10,80){\textbf{c} }\end{overpic}
...
\textbf{(a)} Comparing 3 control architectures to assemble
\textbf{(b)} Comparing 3 control architectures to forage.
\textbf{(c)} Comparing 3 control architectures to escape
}
\end{figure}
