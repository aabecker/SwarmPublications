...
\end{overpic}
\caption{\label{fig:assembly} %Controlling a swarm of robots with global inputs. 
...
Top left: Chapter 2 discusses steering a swarm of particles using global inputs and swarm statistics. Top right: Chapter 3 goes deep into the torque control. Bottom: Chapter 4 demonstrates algorithms to position two robots. %Bottom right: the magnetic setup that is used to manipulate magnetic particles when they both get the same control input.
}
\end{figure}
