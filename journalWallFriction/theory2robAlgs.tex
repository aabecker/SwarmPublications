...
The particles achieve $\Delta g_c$ in two moves. The first move causes one particle to touch the wall, the second move achieves the required relative position.
