...
\end{overpic} 
~~\begin{overpic}[width =0.68\columnwidth]{MaxTorquePivot.pdf}%\put(1,55){a)}
\end{overpic}
%\vspace{-0.5em}
...
If the rod moves slower than the particles, these particles will build up behind the rod in a characteristic triangular shape defined by an apex angle. This piling up is common to all granular media, and the angle formed is a function of the \emph{angle of repose}.% for the media, see \cite{angleofRepose}.
