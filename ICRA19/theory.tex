...
$\alpha$ is a function  of many variables, including the physical shape and composition of the particles and the external force applied.  
 Three different values of angle of repose are shown in Fig.~\ref{fig:angle}. The center of mass (COM) of the rod is in the middle of the rod, but  the COM of the granular particles changes for different $\alpha$ values. % for the media, see \cite{angleofRepose}. 
...
\rotatebox{22.5}{\put(55,-12){\scriptsize $\leftarrow \, \ell \, \, \rightarrow$}}
\end{overpic}\\
\vspace{0.5em}
...
The force for different angle of repose values are shown in Fig.~\ref{fig:AngleOfReposeForce}(b), with the rod length $\ell=1$. 
