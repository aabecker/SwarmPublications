...
Fig.~\ref{fig:Shapes} shows the six equal-area object shapes tested in simulations. Fig.~\ref{fig:story} shows snapshots during an execution of this algorithm in simulation.
