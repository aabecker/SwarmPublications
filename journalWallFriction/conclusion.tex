...
This paper presented techniques for controlling the position of a swarm of particles using uniform inputs and interaction with boundary friction forces.  
...
Future efforts should be directed toward improving the technology and tailoring it to specific particle applications.
