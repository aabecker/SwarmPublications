...
The techniques may have particular relevance for current micro- and nano-robots, whose small size limits onboard computation and power. For this reason these robots are usually powered and controlled by global inputs, such as a uniform external electric or magnetic field, and every robot receives exactly the same control inputs.
