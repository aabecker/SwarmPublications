...
The script runs the experiment and posts the experiment data to the server. 
...
In the {\bf submission} phase the experiment results are combined with other user data, such as the browser user agent string, and submitted to the server for collection.
