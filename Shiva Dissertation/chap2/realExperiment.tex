...
\begin{center}
	...
	\begin{overpic}[width=0.7\columnwidth]{SetUp.pdf}%\put(1,75){A}
	\end{overpic}\\
	\vspace{3em}
	\begin{overpic}[width=0.33\columnwidth]{AllShapesR.pdf}%\put(-0,85){B}
	\end{overpic}
	\begin{overpic}[width=0.6\columnwidth]{PotentialExp.pdf}%\put(-0,85){C}
	\end{overpic}
\end{center}
