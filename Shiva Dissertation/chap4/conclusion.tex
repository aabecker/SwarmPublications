...
This chapter presented techniques for controlling the positions of two particles using uniform inputs and non-slip boundary contacts.  
The chapter provided algorithms for precise position control. The algorithms relied on calculating reachable sets in a 2D $\Delta$ configuration space.
...
This chapter assumed friction was sufficient to completely stop particles in contact with the boundary. 
