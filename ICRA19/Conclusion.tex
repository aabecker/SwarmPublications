...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
This paper presented efficient techniques for reshaping particles using rigid obstacles.  
Hardware experiments illustrated the algorithms in artificial workspaces.
Future work should design workspaces that enable efficient shape reconfiguration, perhaps via molds, and higher-level shape interaction such as mixing or sorting particles.
