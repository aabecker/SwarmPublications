...
\begin{sm}
\begin{itemize}
\item Video 1:  simulation of the parameter sweeps in Fig.~\ref{fig:AutoVeryParam} with robot swarms manipulating objects.
\item Video 2: hardware experiments of object manipulation with a swarm of 100 kilobots.
\end{itemize}
\end{sm}
