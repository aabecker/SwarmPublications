...
Shape control of many particles is essential for navigation, construction, and conveying information. 
 ...
 In previous work, we gave algorithms that could adjust the position of two particles in an environment with walls that have non-slip contacts~\cite{shahrokhi2017}. We assumed that if a particle is pushed into a wall, it will not move until a uniform input pulls it from the wall.
