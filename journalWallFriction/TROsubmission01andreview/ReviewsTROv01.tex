...
## we added  wording about  neutrally buoyant  ``QUOTE CHANGE"
...
##  To maintain clarity, this paper focused on systems with no-slip boundaries.  While several environments with no slip boundaries exist (e.g. tripe, and intestines with villi), extending to lower friction values is a intriguing avenue that unfortunately does not fit within the 12 page limit for this journal, but is something we are investigating. The reachable sets are smaller -- for example, 
