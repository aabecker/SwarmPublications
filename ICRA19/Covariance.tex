...
% paper title
\title{\LARGE \bf Reshaping Particles by Collisions with Rigid Objects}

% You will get a Paper-ID when submitting a pdf file to the conference system
\author{Shiva Shahrokhi and Aaron T. Becker% <-this % stops a space
...
Magnetic actuation has the benefits of requiring no tethers, being able to operate from a distance, and in some cases allows imaging for feedback (e.g. MRI). Reshaping the swarm is necessary if we want to navigate the swarm through the narrow passageways. 
 This paper investigates particle shape control with uniform input.% gradients (the same force is applied everywhere in the workspace).
  First we show how angle of repose of the swarm can be used to reshape the particles. Then we make use of the rigid objects in the environment to control covariance of the swarm. We conclude by simulations and hardware experiments validating our claims. 
