...
Workspace and $\Delta$ configuration space is shown for an arbitrary convex polygon with $n=4$ sides. The 2-side reachable sets are drawn in transparent blue.
}
\end{figure}
