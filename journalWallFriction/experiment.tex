...
The intestine phantom model was used first and was made to mimic the geometry of an intestine and its villi.  To model the geometry of intestinal villi, the model consists of a circular ring cut out of $\SI{6}{\milli\metre}$ thick acrylic.  The ring has an outer diameter of $\SI{50}{\milli\metre}$, an inner diameter of $\SI{46}{\milli\metre}$, and sixty $\SI{2}{\milli\metre}$ long protrusions on its inner surface. The top row of Fig.~\ref{fig:story}  shows one experiment. Starting and ending positions were printed beneath the workspace on transparency film. Our algorithm successfully delivered the particles to goal positions in 10 out of 10 trials.
