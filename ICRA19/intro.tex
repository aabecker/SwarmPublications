...
\caption{\label{fig:leadfigure} 
     Reshaping particles by collisions with rigid bodies. Top pictures illustrate using closed boundaries to reshape the particles. 
      Bottom pictures illustrate with different particles how varying the the angle of attack modifies the shape of particles remaining on a rigid object and how modifying the applied force changes the angle of repose (see video \cite{shahrokhiICRAvideo2019}).
}
\vspace{-1em}
\end{figure}
