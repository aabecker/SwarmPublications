...
Instead, these ``robots''  are  particles carrying some payload and the particle swarm is controlled by a shared, global control input.
...
This paper relaxes this constraint, and provides position control algorithms that only require interactions with the boundaries.
...
This paper provides an optimal shortest-path algorithm for a swarm with two particles, and a generalization to $n$-particle swarms.
