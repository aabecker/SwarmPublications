...
\end{overpic}
%\vspace{-1em}
\caption{\label{fig:expSnapShot}Snapshots showing object manipulation experiment with 100 kilobots under automatic control. The automatic controller generates a policy to the goal. See  supplementary material video 1.}
        \end{figure}
