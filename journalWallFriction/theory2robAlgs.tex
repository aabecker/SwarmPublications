...
As the corner angles increase, the number of moves required to access the entire configuration space increases.  \revision{For a circular workspace, with corner angles of 180$^\circ$, the worst case configuration can only be approached asymptotically, as explained in Section~\ref{sec:simulation}.}
